...
/*   Updated: 2025/08/24 21:40:02 by jmiguele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */


int is_row_valid(char **matrix) {
    int i;
    int j;
    int k;
    i = 0;
